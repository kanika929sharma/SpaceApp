...
3) Maps have been used to toggle the values of launch year, successful launch attribute and successful land attribute with button text as key and their toggled value as
   respective map element value.
4) Boostrap cards have been used to display the launch information.
5) Implemented CSS media queries for responsive design.
6) Code quality check has also been implemented using tslint.
